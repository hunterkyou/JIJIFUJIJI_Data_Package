#随机选一个玩家然后让他出牌
$tellraw @s ["",\
{"text":"【质疑】","color":"red","bold":true,"clickEvent":{"action":"run_command","value":"/trigger jijifujiji_liar_bar_a_table_join set 99"},"hoverEvent":{"action":"show_text","value":"开上家的牌！"}},\
